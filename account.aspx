...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="usernameLbl" runat="server" Width="150px" />
    <br />
    <asp:Label ID="pass" runat="server" Text="Password: " Width="140px" />
    <asp:Label ID="passwordLbl" runat="server" Text="••••••••" Width="150px" />
    <asp:TextBox ID="passwordTxt" TextMode="Password" runat="server" Visible="false" />
    <asp:Button ID="changePassBtn" runat="server" Text="Edit" OnClick="changePassBtn_Click" CssClass="Button" />
    <asp:Panel ID="cnfrmPassPnl" runat="server" Visible="false">
        ...
        <asp:ImageButton ID="changePassNoBtn" runat="server" OnClick="changePassNoBtn_Click" Width="32px" Height="32px" ImageUrl="~/Images/Letter-X-icon.png" />
    </asp:Panel>
    <br />
    <asp:Label ID="email" runat="server" Text="E-mail: " Width="140px" Height="18px" />
    <asp:Label ID="emailAddressLbl" runat="server" Width="150px" />
    ...
    <asp:Label ID="phoneLbl" runat="server" Width="150px" />
    ...
    <asp:Label ID="designerLbl" runat="server" Width="150px" />
</asp:Content>
