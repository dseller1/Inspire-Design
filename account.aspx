...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="cnfrmPassPnl" runat="server" Visible="false">
        ...
        <asp:ImageButton ID="changePassYesBtn" runat="server" OnClick="changePassYesBtn_Click" Width="32px" Height="32px" ImageUrl="~/Images/checkmark.png" />
        <asp:ImageButton ID="changePassNoBtn" runat="server" OnClick="changePassNoBtn_Click" CausesValidation="false" Width="32px" Height="32px" ImageUrl="~/Images/Letter-X-icon.png" />
    ...
    <asp:ImageButton ID="changeEmailNoBtn" runat="server" OnClick="changeEmailNoBtn_Click" Visible="false" CausesValidation="false" Width="32px" Height="32px" ImageUrl="~/Images/Letter-X-icon.png" />
    ...
    <asp:ImageButton ID="changePhoneYesBtn" runat="server" OnClick="changePhoneYesBtn_Click" CausesValidation="false" Visible="false" Width="32px" Height="32px" ImageUrl="~/Images/checkmark.png" />
    <asp:ImageButton ID="changePhoneNoBtn" runat="server" OnClick="changePhoneNoBtn_Click" CausesValidation="false" Visible="false" Width="32px" Height="32px" ImageUrl="~/Images/Letter-X-icon.png" />
    <br />
    ...
    <asp:Panel ID="designerPnl" runat="server" Visible="false">
        ...
        <asp:ImageButton ID="addClientYesBtn" runat="server" OnClick="addClientYesBtn_Click" CausesValidation="false" Visible="false" Width="32px" Height="32px" ImageUrl="~/Images/checkmark.png" />
        <asp:ImageButton ID="addClientNoBtn" runat="server" OnClick="addClientNoBtn_Click" CausesValidation="false" Visible="false" Width="32px" Height="32px" ImageUrl="~/Images/Letter-X-icon.png" />
