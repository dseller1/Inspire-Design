...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="cnfrmPassPnl" runat="server" Visible="false">
        ...
        <asp:ImageButton ID="changePassNoBtn" runat="server" OnClick="changePassNoBtn_Click" CausesValidation="false" style="position: relative; top: 4px;" Width="19px" Height="19px" ImageUrl="~/Images/redX.png" />
    ...
    <asp:Panel ID="emailPnl" runat="server">
        ...
        <asp:ImageButton ID="changeEmailYesBtn" runat="server" OnClick="changeEmailYesBtn_Click" style="position: relative; top: 4px;" Visible="false" Width="19px" Height="19px" ImageUrl="~/Images/greenmark.png" />
    ...
    <asp:Panel ID="designerPnl" runat="server" Visible="false">
        ...
        <asp:ImageButton ID="addClientYesBtn" runat="server" OnClick="addClientYesBtn_Click" CausesValidation="false" Visible="false" style="position: relative; top: 4px;" Width="19px" Height="19px" ImageUrl="~/Images/greenmark.png" />
        <asp:ImageButton ID="addClientNoBtn" runat="server" OnClick="addClientNoBtn_Click" CausesValidation="false" Visible="false" style="position: relative; top: 4px;" Width="19px" Height="19px" ImageUrl="~/Images/redX.png" />
