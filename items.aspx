...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="optionsPnl" runat="server" Visible="true">
        ...
        <br />
        <asp:Button ID="showItemsBtn" runat="server" Text="Show Items" OnClick="showItemsBtn_Click" class="Button" Width="115px" />
        <asp:Button ID="changeBoardBtn" runat="server" OnClick="changeBoardBtn_Click" Text="Change Board" class="Button" Width="115px" />
    </asp:Panel>
    <asp:Panel ID="boardPnl" runat="server" Visible="false">
        ...
        <asp:Button ID="chooseBrdBtn" runat="server" Text="Select Board" OnClick="chooseBrdBtn_Click" class="Button" Width="115px" />
        <asp:Button ID="createBoardBtn" runat="server" Text="Create Board" OnClick="createBoardBtn_Click" class="Button" Width="115px" />
        ...
        <asp:Panel ID="newBoardPnl" runat="server" Visible="false" Width="413px" HorizontalAlign="Right">
            ...
            <asp:Button ID="newBoardBtn" runat="server" Text="Submit" OnClick="newBoardBtn_Click" class="Button" />
        </asp:Panel>
    </asp:Panel>
